...
<qgis version="2.10.1-Pisa" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="cycleway" label="cycleway"/>
      <category render="true" symbol="1" value="footway" label="footway"/>
      <category render="true" symbol="2" value="living_street" label="living_street"/>
      <category render="true" symbol="3" value="path" label="path"/>
      <category render="true" symbol="4" value="pedestrian" label="pedestrian"/>
      <category render="true" symbol="5" value="primary" label="primary"/>
      <category render="true" symbol="6" value="primary_link" label="primary_link"/>
      <category render="true" symbol="7" value="residential" label="residential"/>
      <category render="true" symbol="8" value="road" label="road"/>
      <category render="true" symbol="9" value="secondary" label="secondary"/>
      <category render="true" symbol="10" value="secondary_link" label="secondary_link"/>
      <category render="true" symbol="11" value="service" label="service"/>
      <category render="true" symbol="12" value="tertiary" label="tertiary"/>
      <category render="true" symbol="13" value="tertiary_link" label="tertiary_link"/>
      <category render="true" symbol="14" value="track" label="track"/>
      <category render="true" symbol="15" value="trunk" label="trunk"/>
      <category render="true" symbol="16" value="trunk_link" label="trunk_link"/>
      <category render="true" symbol="17" value="unclassified" label="unclassified"/>
      <category render="true" symbol="18" value="yes" label="yes"/>
    ...
    <source-symbol>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="244,234,92,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.46"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="255,253,223,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.36"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
