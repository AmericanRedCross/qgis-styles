...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{d8d10266-7880-4711-895a-9ff5c3a545a1}">
      ...
      <rule scalemaxdenom="15000" filter=" &quot;building&quot; IS NOT NULL" key="{9ccb8aad-91a3-4054-bf0b-77f99a3be07a}" symbol="6" scalemindenom="1" label="building">
        <rule checkstate="0" filter="&quot;building&quot; IN ( 'church','cathedral') OR &quot;amenity&quot; = 'place_of_worship'" key="{974a1732-d925-4b71-b1dd-b1a445369a6b}" symbol="7" label="church"/>
      </rule>
      <rule filter="&quot;natural&quot; = 'wetland'" key="{4ac3d790-8e39-4ac2-aa44-42fcb00096b1}" symbol="8" label="wetland"/>
      <rule scalemaxdenom="25000" filter=" &quot;aeroway&quot;  =  'aerodrome' " key="{9e4e36e4-7df2-40fd-a6d2-f6e219289ca1}" symbol="9" scalemindenom="500" label="airport"/>
      ...
      <rule scalemaxdenom="25000" filter="&quot;amenity&quot; = 'marketplace'" key="{c144b42d-71de-44f2-a7e0-258f315b8221}" symbol="13" scalemindenom="500" label="marketplace"/>
      <rule scalemaxdenom="50000" filter="&quot;amenity&quot; = 'embassy'" key="{de5201b5-e8c7-4190-a45c-dfea802ac985}" symbol="14" scalemindenom="500" label="embassy"/>
      <rule scalemaxdenom="25000" filter="&quot;amenity&quot; = 'hospital' or &quot;amenity&quot; = 'clinic'" key="{5bbf688a-6336-4577-8ff6-f51d61f75454}" symbol="15" scalemindenom="500" label="hospital or clinic"/>
      <rule scalemaxdenom="25000" filter="&quot;amenity&quot; = 'graveyard' OR &quot;landuse&quot; = 'cementery'" key="{29560fc7-7514-432d-847f-dd2b01a3e2d2}" symbol="16" scalemindenom="500" label="cementery"/>
      <rule filter=" &quot;admin_level&quot;  = 4" key="{abc45a88-bc54-4052-9f9f-0bd3dce6e979}" symbol="17" label="background_land"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="8">
        ...
        <layer pass="0" class="SVGFill" locked="0">
          ...
          <prop k="width" v="8"/>
          <symbol alpha="0" type="line" name="@8@1">
