...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{b42ac442-b1d9-4d7f-8b68-ae119ad2465c}">
      <rule filter=" &quot;man_made&quot; = 'watertap' or &quot;man_made&quot; = 'water_well'" key="{32d84df9-a8e1-4e0a-8391-79238c164136}" symbol="0" label="water_points"/>
      <rule filter="&quot;man_made&quot; = 'water_tank'&#xa;" key="{083c30f4-ecbd-4834-b796-36d94cd10030}" symbol="1" label="water_tank"/>
      <rule filter="&quot;man_made&quot; LIKE '%wastewater%' OR &quot;man_made&quot; LIKE '%sewer%' " key="{719d5a06-0f1c-4754-a7d3-1857d2e8d37f}" symbol="2" label="sewer and wastewater treatment"/>
      <rule filter="&quot;man_made&quot; = 'water_tower'" key="{ff3705c8-8b4c-4a63-baae-3bf02a8c6209}" symbol="3" label="water_infrastructure"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="2">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="../noun_51417 2.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#ffffff"/>
      ...
      <symbol alpha="1" type="marker" name="3">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="#87d7e3"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="../noun_25021.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#7cc6dc"/>
          <prop k="outline_width" v="1"/>
          <prop k="outline_width_map_unit_scale" v="0,0"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="scale_method" v="area"/>
